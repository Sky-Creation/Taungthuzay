...
public class Create_account extends Activity {
    ...
    private void initControls() {
        newUsername = findViewById(R.id.nUsername);
        newPassword = findViewById(R.id.nPassword);
        newConfiPass = findViewById(R.id.nConfiPass);
        Button registerButton = findViewById(R.id.nRegister);
        Button clearButton = findViewById(R.id.nClear);
        Button backButton = findViewById(R.id.nBack);
